...
function __init__()
    @require CuArrays = "3a865a2d-5b23-5a0f-bc46-62713ec82fae" begin
        ...
        @require Tracker = "9f7883ad-71c0-57eb-9f7f-b5c9e6d3789c" begin
            ...
            gpu_or_cpu(x::Adjoint{<:Any,TrackedArray{<:Any,<:Any,<:CuArrays.CuArray}}) =
                CuArrays.CuArray
            gpu_or_cpu(x::Transpose{<:Any,TrackedArray{<:Any,<:Any,<:CuArrays.CuArray}}) =
                CuArrays.CuArray
            isgpu(::TrackedArray{<:Any,<:Any,<:CuArrays.CuArray}) = true
            ifgpufree(x::TrackedArray{<:Any,<:Any,<:CuArrays.CuArray}) =
            ...
            ifgpufree(x::Adjoint{<:Any,TrackedArray{<:Any,<:Any,<:CuArrays.CuArray}}) =
                CuArrays.unsafe_free!((x.data).parent)
            ifgpufree(x::Transpose{<:Any,TrackedArray{<:Any,<:Any,<:CuArrays.CuArray}}) =
                CuArrays.unsafe_free!((x.data).parent)
        end
    end
    ...
    @require CUDA = "052768ef-5323-5732-b1bb-66c8b64840ba" begin
        ...
        @require Tracker = "9f7883ad-71c0-57eb-9f7f-b5c9e6d3789c" begin
            ...
            gpu_or_cpu(x::Adjoint{<:Any,TrackedArray{<:Any,<:Any,<:CUDA.CuArray}}) =
                CUDA.CuArray
            gpu_or_cpu(x::Transpose{<:Any,TrackedArray{<:Any,<:Any,<:CUDA.CuArray}}) =
                CUDA.CuArray
            ...
            ifgpufree(x::TrackedArray{<:Any,<:Any,<:CUDA.CuArray}) =
