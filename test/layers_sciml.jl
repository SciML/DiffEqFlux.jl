...
pmin = DiffEqFlux.sciml_train(loss_rd, :adaptive_de_rand_1_bin, lower_bounds = [0.0 for i in 1:4], upper_bounds = [5.0 for i in 1:4], cb = cb)
loss2 = loss_rd(best_candidate(pmin))
@test 10loss2 < loss1
