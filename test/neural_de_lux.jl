...
sode = NeuralDSDE(luxdudt,luxdudt2,(0.0f0,.1f0),LambaEulerHeun(),saveat=0.0:0.01:0.1)
...
sode = NeuralSDE(luxdudt,luxdudt22,(0.0f0,0.1f0),2,LambaEulerHeun(),saveat=0.0:0.01:0.1)
pd,st = Lux.setup(rng, sode)
