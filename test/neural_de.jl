...
node = NeuralODE(fastdudt, tspan, Tsit5(), abstol = 1e-12, reltol = 1e-12,
...
@testset "adjoint mode" begin
    ...
    @test_broken grads = Zygote.gradient(() -> sum(node(xs)), Flux.params(xs, node)) isa
                         Tuple
...
NeuralDSDE(dudt, dudt2, (0.0f0, 0.1f0), SOSRI(), saveat = 0.1)(x)
sode = NeuralDSDE(dudt, dudt2, (0.0f0, 0.1f0), SOSRI(), saveat = 0.0:0.01:0.1)
...
sode = NeuralDSDE(fastdudt, fastdudt2, (0.0f0, 0.1f0), SOSRI(), saveat = 0.0:0.01:0.1)
...
NeuralSDE(dudt, dudt22, (0.0f0, 0.1f0), 2, LambaEM(), saveat = 0.01)(x)
...
NeuralCDDE(ddudt, (0.0f0, 2.0f0), (p, t) -> zero(x), (1.0f-1, 2.0f-1),
           MethodOfSteps(Tsit5()), saveat = 0.1)(x)
dode = NeuralCDDE(ddudt, (0.0f0, 2.0f0), (p, t) -> zero(x), (1.0f-1, 2.0f-1),
...
NeuralCDDE(fastddudt, (0.0f0, 2.0f0), (p, t) -> zero(x), (1.0f-1, 2.0f-1),
           MethodOfSteps(Tsit5()), saveat = 0.1)(x)
dode = NeuralCDDE(fastddudt, (0.0f0, 2.0f0), (p, t) -> zero(x), (1.0f-1, 2.0f-1),
                  MethodOfSteps(Tsit5()), saveat = 0.0:0.1:2.0)
