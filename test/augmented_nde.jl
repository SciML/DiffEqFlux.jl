using ComponentArrays,
    DiffEqFlux, Flux, Zygote, DelayDiffEq, OrdinaryDiffEq, StochasticDiffEq, Test, Random
import Lux
...
anode = AugmentedNDELayer(NeuralODE(fluxdudt,
        tspan,
        Tsit5(),
...
andsde = AugmentedNDELayer(NeuralDSDE(fluxdudt,
        fluxdudt2,
        (0.0f0, 0.1f0),
        SOSRI(),
        saveat = 0.0:0.01:0.1), 2)
andsde(x)
...
asode = AugmentedNDELayer(NeuralSDE(fluxdudt,
        fluxdudt22,
        (0.0f0, 0.1f0),
        4,
        LambaEM(),
...
adode = AugmentedNDELayer(NeuralCDDE(fluxddudt, (0.0f0, 2.0f0), (p, t) -> zeros(Float32, 4),
        (1.0f-1, 2.0f-1),
...
# Augmented Neural ODE
anode = AugmentedNDELayer(NeuralODE(dudt,
        tspan,
        Tsit5(),
        save_everystep = false,
        save_start = false), 2)
...
# Augmented Neural DSDE
andsde = AugmentedNDELayer(NeuralDSDE(dudt,
        dudt2,
        (0.0f0, 0.1f0),
        EulerHeun(),
        saveat = 0.0:0.01:0.1,
...
# Augmented Neural SDE
asode = AugmentedNDELayer(NeuralSDE(dudt,
        dudt22,
        (0.0f0, 0.1f0),
        4,
        EulerHeun(),
